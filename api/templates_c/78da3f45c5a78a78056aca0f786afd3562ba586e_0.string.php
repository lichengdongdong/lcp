<?php
/* Smarty version 3.1.32, created on 2018-07-04 11:34:41
  from '78da3f45c5a78a78056aca0f786afd3562ba586e' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5b3c4051d46594_44252872',
...
function content_5b3c4051d46594_44252872 (Smarty_Internal_Template $_smarty_tpl) {
echo '<?php
...
?>
  <?php if ($_smarty_tpl->tpl_vars['f']->value['name'] <> 'id') {?>
   	if($this-><?php echo $_smarty_tpl->tpl_vars['f']->value['name'];?>
==''){
...
实体 
 ...
 $<?php echo $_smarty_tpl->tpl_vars['data']->value['table'];?>
,$isvalide=0) {
		//基本类信息验证 
		$<?php echo $_smarty_tpl->tpl_vars['data']->value['object'];?>
->validate ();
...
->id ) != 0){
		...
		//数据更新			
			$sql = "update <?php echo $_smarty_tpl->tpl_vars['data']->value['object'];?>
 set
            <?php
...
;
 ...
 ( <?php echo $_smarty_tpl->tpl_vars['data']->value['Object'];?>
		...
		*/
		...
		$sql = "select a.* from <?php echo $_smarty_tpl->tpl_vars['data']->value['object'];?>
 a where a.id='<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
'  limit 1";
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 ";
		...
		//组装sql语句
		$sql = "select <?php echo $_smarty_tpl->tpl_vars['para']->value;?>
 from <?php echo $_smarty_tpl->tpl_vars['data']->value['object'];?>
 a  <?php echo $_smarty_tpl->tpl_vars['leftJoinSql']->value;?>
 where 1 <?php echo $_smarty_tpl->tpl_vars['whereSql']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['groupBySql']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['orderSql']->value;?>
";
